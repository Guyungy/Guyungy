<picture>
  ...
  <img alt="Guyungy — AI Delivery, Workflow Systems and Product Engineering" src="./assets/profile-header-light.svg" width="100%">
</picture>
...
<table>
  <tr>
    ...
    <td width="33%" valign="top">
      <strong>Delivery Engineering</strong><br><br>
      需求澄清、方案设计、权限安全、集成验证与客户场景落地。
    </td>
    <td width="33%" valign="top">
      <strong>Internal Products</strong><br><br>
...
<div align="center">
  <picture>
    ...
    <img src="./profile-summary-card-output/github/0-profile-details.svg" alt="Guyungy GitHub profile details" width="100%">
  </picture>
  <br>
  <picture>
    ...
    <img src="./profile-summary-card-output/github/1-repos-per-language.svg" alt="Repositories by language" width="48%">
  </picture>
  <picture>
    ...
    <img src="./profile-summary-card-output/github/2-most-commit-language.svg" alt="Most used commit languages" width="48%">
  </picture>
  <br>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./profile-summary-card-output/github_dark/3-stats.svg">
    <source media="(prefers-color-scheme: light)" srcset="./profile-summary-card-output/github/3-stats.svg">
    <img src="./profile-summary-card-output/github/3-stats.svg" alt="GitHub statistics" width="41%">
  </picture>
  <picture>
    ...
    <img src="./profile-summary-card-output/github/4-productive-time.svg" alt="Productive time" width="55%">
  </picture>
  <br><br>
  <sub>由 GitHub Actions 每 6 小时自动刷新，也可在 Actions 页面手动更新。</sub>
</div>
...
<details>
  <summary><strong>我通常如何推进一个项目</strong></summary>
  <br>
...
<div align="center">
  ...
  <br><br>
  <sub>Clarity over noise · Systems over demos · Outcomes over features</sub>
</div>
